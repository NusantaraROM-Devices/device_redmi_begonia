APPEND_CERTS := $(DEVICE_PATH)/configs/dtbo/append_certs.py
...
$(BOARD_PREBUILT_DTBOIMAGE):
	...
	$(APPEND_CERTS) --alignment 16 --cert1 $(DEVICE_PATH)/configs/dtbo/cert1.der --cert2 $(DEVICE_PATH)/configs/dtbo/cert2.der --dtbo $(BOARD_PREBUILT_DTBOIMAGE)
